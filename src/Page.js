  ...
  return (<>
    ...
    <div className='screen'>
      ...
      <div id={first_half_layer} className='firsthalf'>
        ...
        <img className={top_p_text[3] === 'ABC 23478' ? 'fadein' : 'fadeout'} style={{width: '300px', marginLeft: '-50%', marginTop: '30vh'}} alt='img' src={l7fhimg}/>
      ...
      <div id={second_half_layer} className='secondhalf'>
            ...
            <div style={{color: 'white', width: '100%', height: '50vh', background: 'linear-gradient(141deg, rgba(201,74,141,1) 0%, rgba(201,74,141,1) 0%, rgba(80,59,146,1) 100%)'}}>
                <div style={{left: '5%', position: 'absolute', right: '5%'}}>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <p style={{width: '125px', height: '35px', textAlign: 'center', backgroundColor:'#c94a8d', borderRadius: '25px', paddingTop: '15px', fontWeight: '500', marginTop: '1px'}}>Coming Soon</p>
                    </div>
                </div>
            </div>
        </div>
        <div class='item' style={{width: '100%'}}>
            ...
            <div style={{position: 'absolute', color: 'white', width: '100%', height: '50vh', background: '#0e1138'}}>
                <div style={{left: '5%', position: 'absolute', right: '5%'}}>
                    ...
                    <div style={{display: 'flex'}}>
                        <p style={{fontWeight: '500'}}>CASE STUDY - </p>
                        <p style={{width: '125px', height: '35px', textAlign: 'center', backgroundColor:'lightgray', color: 'black', borderRadius: '25px', paddingTop: '15px', fontWeight: '500', marginTop: '1px'}}>Coming Soon</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class='item' style={{width: '100%'}}>
            ...
            <div style={{zIndex: '2', color: 'white', width: '100%', height: '50vh', backgroundColor: '#33834d', position: 'absolute'}}>
                <div style={{left: '5%', position: 'absolute', right: '5%'}}>
                    <img style={{marginTop: '-15px', width: '70%', backgroundColor:'white', border: '3px solid #33834d', borderRadius: '15px'}} alt='img 1' src={l7fhimg}/>
                    <h1>XYZ 123</h1>
                    <p>This is sample text for XYZ 123. This is sample text for ABC 123.</p>
                    <br />
                    <div style={{display: 'flex'}}>
                        <p style={{fontWeight: '500'}}>CASE STUDY - </p>
                        <p style={{width: '125px', height: '35px', textAlign: 'center', fontWeight: '500', backgroundColor:'lightgray', color: '#33834d', borderRadius: '25px', paddingTop: '15px', marginTop: '1px'}}>Coming Soon</p>
                    </div>
                </div>
            </div>
        </div>
